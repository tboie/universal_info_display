...
const sampleText =
  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Eu facilisis sed odio morbi quis. Duis tristique sollicitudin nibh sit amet commodo nulla. Suspendisse Todia estimate tada finale. And there will once again be one more final sentence to end the paragraph with.";
